...
from win.views import football_upload,vip,gol, home_view, home_wins,to_win,top_pick, home_loose, raw_predictions, away_wins, away_loose, over_goals, under_goals, now
